...
import SvgPicture5 from './SvgPicture5.vue'
</script>

<template>
	<div class="card">
		<div class="card-info-content">
			<h3 class="title">Осветление пигментации и сияние кожи.</h3>
			<h5 class="subtitle">
		...
		<div class="card-badges">
			...
			<div class="card-badge">Brigth Concept</div>
		</div>
	</div>
</template>
