...
import SvgPicture6 from './SvgPicture6.vue'
</script>

<template>
	<div class="card">
		<div class="card-info-content">
			<h3 class="title">Увлажнение кожи, устранение сухости.</h3>
			<h5 class="subtitle">
		...
		<div class="card-badges">
			...
			<div class="card-badge">Hydro Concept</div>
		</div>
	</div>
</template>
