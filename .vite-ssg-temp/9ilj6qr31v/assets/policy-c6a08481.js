import { useSSRContext, mergeProps, withCtx, unref, createVNode, openBlock, createBlock, Fragment, renderList } from "vue";
...
const SectionPolicy = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-02c3572f"]]);
const _sfc_main = {
  __name: "policy",
  __ssrInlineRender: true,
  setup(__props) {
...
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("src/pages/policy.vue");
