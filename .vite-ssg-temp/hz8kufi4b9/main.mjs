    ...
    children: [
      {
        path: ":index",
        name: "/concept/[index]",
        component: () => import("./assets/_index_-09c6674e.js")
        /* no children */
      }
    ]
  },
...
async function includedRoutes(paths, routes2) {
  routes2.flatMap((route) => {
    return route.path === "/concept/:index" ? "/concept/bright" : route.path;
  });
  paths.flatMap((path) => {
    return path === "/concept/:index" ? console.log("CONCEPT/BRIGHT") : path;
  });
  console.log(paths);
