...
const SectionTech = /* @__PURE__ */ _export_sfc(_sfc_main$a, [["__scopeId", "data-v-98c71603"]]);
...
const SectionBannerBadges = /* @__PURE__ */ _export_sfc(_sfc_main$9, [["ssrRender", _sfc_ssrRender$3], ["__scopeId", "data-v-1fe0908a"]]);
const BannerTitle_vue_vue_type_style_index_0_scoped_042def5a_lang = "";
const _sfc_main$8 = {
  __name: "BannerTitle",
  __ssrInlineRender: true,
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<h2${ssrRenderAttrs(mergeProps({ class: "banner-title" }, _attrs))} data-v-042def5a> Преобразуй свою кожу `);
...
_sfc_main$8.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("src/components/sections/main/section-banner/BannerTitle.vue");
  return _sfc_setup$8 ? _sfc_setup$8(props, ctx) : void 0;
};
const BannerTitle = /* @__PURE__ */ _export_sfc(_sfc_main$8, [["__scopeId", "data-v-042def5a"]]);
...
const SectionBannerBlock_vue_vue_type_style_index_0_scoped_e15c3ef8_lang = "";
const _sfc_main$5 = {
  __name: "SectionBannerBlock",
  __ssrInlineRender: true,
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "banner" }, _attrs))} data-v-e15c3ef8><div data-v-e15c3ef8><img class="banner-picture"${ssrRenderAttr("src", _imports_0)} alt="" data-v-e15c3ef8>`);
...
const SectionBannerBlock = /* @__PURE__ */ _export_sfc(_sfc_main$5, [["__scopeId", "data-v-e15c3ef8"]]);
...
const SectionBanner_vue_vue_type_style_index_0_scoped_3d4568f1_lang = "";
const _sfc_main$3 = {
  __name: "SectionBanner",
  __ssrInlineRender: true,
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<section${ssrRenderAttrs(mergeProps({ class: "section-banner" }, _attrs))} data-v-3d4568f1><div class="container-custom" data-v-3d4568f1><div class="content" data-v-3d4568f1>`);
      _push(ssrRenderComponent(SectionBannerBlock, { class: "banner" }, null, _parent));
      _push(`<div class="content-info" data-v-3d4568f1>`);
      _push(ssrRenderComponent(BannerTitle, null, null, _parent));
...
const SectionBanner = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["__scopeId", "data-v-3d4568f1"]]);
const mousewheel = "";
const sliderCustom = "";
